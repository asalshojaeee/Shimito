...
border border-[#EF2CC5]
  ...
  <div className="flex shrink-0 gap-2">
    <button
      type="button"
      className="
        h-11 whitespace-nowrap rounded-xl
        border border-[#EF2CC5]
        bg-[#99008A]
