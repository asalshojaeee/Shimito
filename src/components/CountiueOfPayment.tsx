    ...
    <div className="w-full flex flex-col gap-3">
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <button
          ...
          className="w-14 h-12 rounded-3xl bg-[#FF00E533] text-white text-3xl font-medium"
        >
          +
        </button>
        ...
        <button
          ...
          className="w-14 h-12 rounded-3xl bg-gradient-to-t from-[#FF00E533] to-[#99008ACC] border border-[#EF2CC5] text-white text-3xl font-medium"
        >
          -
        </button>


        <p className="text-white bg-[#FF00E51A] p-4 rounded-xl font-bold text-lg">
          {quantity}
        </p>
        ...
        <div className="flex items-center gap-2 mr-auto">
          ...
          <div className="shrink-0 rounded-full bg-[#99008A] px-4 py-2 text-sm text-white whitespace-nowrap">
            کیلو گرم
          </div>

          <div className="shrink-0 rounded-full bg-[#FF00E51A] px-4 py-2 text-sm text-white whitespace-nowrap">
            تن
          </div>
